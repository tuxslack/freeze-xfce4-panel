...
if [ ! -d "$PASTA_USUARIO" ] || [ ! -f "$PASTA_USUARIO/$ARQUIVO" ]; then
    ...
    yad --center --window-icon="$logotipo" --error --title="Erro" --text="Arquivo ou pasta do usuário não encontrados: $PASTA_USUARIO/$ARQUIVO" --buttons-layout=center --button=OK:0 2>/dev/null
...
if [ ! -d "$PASTA_SISTEMA" ]; then
    ...
    yad --center --window-icon="$logotipo" --error --title="Erro" --text="Pasta do sistema não encontrada: $PASTA_SISTEMA" --buttons-layout=center --button=OK:0 2>/dev/null
...
#    sleep 5
    ...
    yad --center --window-icon="$logotipo" --info --title="Congelar Painel" --text="Você escolheu travar.\nO painel será reiniciado agora para aplicar as configurações." --buttons-layout=center --button=OK:0 2>/dev/null
    ...
    # yad --center --window-icon="$logotipo" --info --title="Descongelar Painel" --text="Você escolheu destravar.\nO sistema será reiniciado para aplicar as configurações." --buttons-layout=center --button=OK:0 2>/dev/null
